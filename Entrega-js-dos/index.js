...
alert("Hola, bienvenido/a a este pequeño juego de adivinanza!");
...
alert ("Bienvenido/a esta aventura  " + nombre + ", comenzaremos el juego!!");

alert("Este tratara de adivinanzas, donde puedes ganar o perder puntos. Vamos a empezar!!");

let puntos= 100;

mostrarPuntos(puntos)

alert ("Elije un personaje para adivinar el número que tiene en mente, si asiertas su número sumas puntos, de lo contrario restaras!!")
...
alert("¡¡Genial!! Elegiste a " + personajes[personajeElegido] + ", ahora comnzaremos con la adivinanza!!")
